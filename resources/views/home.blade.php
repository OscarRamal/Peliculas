      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 px-4 text-white  hover:text-black hover:text-underline font-black " href="{{url('mispeliculas')}}">Mis Películas</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-white font-black hover:text-black hover:text-underline py-2 px-4" href="{{url('favoritos')}}">Favoritos</a>
              </li>
              <li class="mr-3">
                <a class="inline-block text-white font-black hover:text-black hover:text-underline py-2 px-4" href="{{url('contacta')}}">Soporte</a>
                </li>
            <li class="mr-3">
              <a class="inline-block text-white font-black hover:text-black hover:text-underline py-2 px-4" href="{{url('peliculasrecom')}}">Películas Recomendadas</a>
            <li class="mr-3">
            </li>
            <li class="mr-3">
...
<a href="{{ url('prime') }}" id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-black font-black rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="mt-14 flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <a href="{{ url('prime') }}" class="leading-normal text-2xl mb-8">
           Disfruta de tus películas favoritos y registrate Premium para ver nuestra Tienda!
         </a>
          <a href="{{ url('prime') }}" id="navAction" class="mx-auto lg:mx-0 hover:underline bg-white text-black font-black rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
            Premium!
    </a>
  ...
  <iframe src="https://www.youtube.com/embed/DT3GnJStVEw?autoplay=1&mute=1" width="700" height="360" allow="autoplay"></iframe>
