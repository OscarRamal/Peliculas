            ...
            <section class="flex flex-col break-words bg-white sm:border-2 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="name" type="text" class="form-input text-black border-2 border-black w-full  @error('name')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="email" type="email"
                            class="form-input w-full text-black border-2 border-black @error('email') border-red-500 @enderror" name="email"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password" type="password"
                            class="form-input w-full text-black border-2 border-black @error('password') border-red-500 @enderror" name="password"
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <input id="password-confirm" type="password" class="form-input w-full text-black border-2 border-black"
